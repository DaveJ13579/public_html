...
$fname=''; $fstatus=" "; $factive=" and Active='Yes' "; $fbranch=''; $fsort=" order by regdate desc "; // default filter terms
$postStatus='All'; $postActive='All'; $postName=''; $postOrder="regdate"; $postBranch='All'; // default POSTed variables
...
$soonquery = "SELECT ID_site from sites where 2=2 $fstatus $fname $fbranch ";
// echo $soonquery.'<br />'; 
...
$query = "SELECT ID_site, farm, contact1, address, branch, crops, regdate, soon from sites where 2=2 $factive $fstatus $fname $fbranch $fsort ";
//echo $query.'<br />'; 
