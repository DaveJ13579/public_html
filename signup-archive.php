...
if(date('Y-m-d H:i')>$hdatetime) { $sorry="past";   header("Location: sorry.php?sorry=$sorry"); exit(); }
...
$insertSQL ="insert into rosters (ID_harvest, regdate, ID_picker, seats, status, IPaddress) values ($harvest, now(), $IDpicker, $seats, '$status', '$IPaddress')";
...
<br />
 ...
 <br />
<div style="padding:10px;width:80%;border:solid 1px black; color:#000000; font-family:'Times New Roman', Times, serif; margin:auto">
