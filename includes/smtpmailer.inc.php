...
function smtpmail($to, $subject, $message, $from, $html=false) {
global $piercecty; 
if($_SERVER["SERVER_ADDR"] == "127.0.0.1") {$port = "25"; }// local server
 else {$port = "465"; }// production server
...
$message.="\n\n\n\nIf you do not want to receive email from Pierce County Gleaning Project, send a note to info@piercecountygleaningproject.org and your email address will be removed from our list.";
