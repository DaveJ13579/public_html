...
$donorq="select farm, contact1, maddress, mcity, mstate, mzip from harvests, sites where year(h_date)=$year and venue='Backyard' and wgt1>0 and harvests.ID_site=sites.ID_site group by farm order by farm, h_date";
