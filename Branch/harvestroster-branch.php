...
<title>Glean information and roster</title>
<style type="text/css">
<!--
.clearcell {
...
<h2>Harvest Information and Roster</h2>
    ...
    <tr>
      ...
      <td><strong>site</strong>: <?php echo $siterow['farm']; ?><br />
        ...
        <strong>venue</strong>: <?php echo $siterow['venue']; ?><br />
         <strong>more site details</strong>: <a href ="sitedetail-branch.php?sitetemp=<?php echo $siterow['ID_site'];?>"><?php echo $siterow['ID_site']; ?></a></td>
...
<br /><br />
  <table  align="center" cellpadding="10" cellspacing="2" border="1" width="1000" >
    <tr>
    	<th colspan="2">Harvest Leader</th><th colspan="2">co-Leader</th></tr>
	...
	<td colspan="2"><?php echo $coldrrow['fname']; ?> <?php echo $coldrrow['lname']; ?>, <?php echo $coldrrow['phone']; ?> <?php echo $coldrrow['phone2']; ?>, <?php echo $coldrrow['email']; ?></td></tr>
<tr>
<th colspan="4">Harvest signup links</th>
</tr>
<tr>
<td colspan="4">This link will add the person to a harvest regardless of how many are already on the roster. It is usually used to add  leaders or selected assistants who will be at the harvest but did not get on the roster before it was filled. The link may copied and pasted to send it to volunteers who do not have database access.<table align="center"><tr><th><strong><a href="http://www.piercecountygleaningproject.org/signup.php?access=link&amp;harvesttemp=<?php echo $harvest;?>"> http://www.piercecountygleaningproject.org/signup.php?access=link&amp;harvesttemp=<?php echo $harvest;?></a></strong></th></tr></table>
</td>
</tr>
<tr>
...
<tr>
<td  align="center"><a href="harvestroster-piercecty-packet-branch.php?harvesttemp=<?php echo $harvest; ?>">Printable roster</a></td>
<td  align="center"><a href="../Branch/harvestupdate-branch.php?harvesttemp=<?php echo $harvest;?>">Update harvest information</a></td>
<td  align="center"><a href="../Branch/sitedetail-branch.php?sitetemp=<?php echo $siterow['ID_site']?>">View site information</a></td>
</tr>
</table>
